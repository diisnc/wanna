...
class Wanted extends Component {
    ...
    genRow(post) {
        ...
        */
        ...
        // build javascript
        items.push(
            <View key={"superTile" + post} style={{height: 200, flexDirection: 'row', alignItems: 'stretch', backgroundColor: 'green'}}>
                <View style={{flex: 1, backgroundColor: 'pink', margin: 10}}>
                    <View key={"tile" + post} style={{flex: 1, backgroundColor: 'yellow', margin: 10}}>
                        ...
                        */}
                        <Image
                            source={{uri: "data:" + this.state.wishlistData[post].photoType1 + ";base64," + objJsonB641 + ""}}
                            style={{
                                width: 'auto',
                                height: '80%',
                                aspectRatio: 1,
                ...
                <View style={{flex: 1, backgroundColor: 'grey', margin: 10}}>
                    <View key={"tile" + post+1} style={{flex: 1, backgroundColor: 'red', margin: 10}}>
                        ...
                        */}
                        <Image
                            source={{uri: "data:" + this.state.wishlistData[post+1].photoType1 + ";base64," + objJsonB642 + ""}}
                            style={{
                                width: 'auto',
                                height: '80%',
                                aspectRatio: 1,
