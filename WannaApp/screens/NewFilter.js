        ...
        return (
            <ScrollView scrollEventThrottle={16}>
                <View style={{ flex: 1, backgroundColor: 'white', margin: 10 }}>
                    {/* género */}
                    <View key={"genre"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleGenre({selected: value})}}
                            options={this.state.optionsGenre}
                            defaultValue={"Género"}
                            dropdownTextStyle={{backgroundColor: '#fff',fontSize:17}}/*Style here*/
                            style={{flex: 1, backgroundColor:'#fff',borderRadius: 30,backgroundColor: 'rgb(19, 119, 237)'}}
                            textStyle={{fontSize: 20, margin: 10, color: 'white'}}
                            dropdownStyle={{width: '60%'}}
                        />
                    </View>
                    {/* tipo roupa */}
                    <View key={"clothe"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleClothe({selected: value})}}
                    ...
                    {/* cor */}
                    <View key={"color"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleColor({selected: value})}}
                    ...
                    {/* tamanhos */}
                    <View key={"sizes"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleSizes({selected: value})}}
                    ...
                    {/* preço minimo */}
                    <View key={"minPrice"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleMinPrice({selected: value})}}
                    ...
                    {/* preço maximo */}
                    <View key={"maxPrice"} style={{height: 80, flexDirection: 'row', backgroundColor: 'green'}}>
                        <ModalDropdown
                            onSelect={(index,value)=>{this.handleMaxPrice({selected: value})}}
                    ...
                    ? (
                        <Button title="Adicionar" onPress={console.log("Submit: " + 
