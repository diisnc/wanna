          ...
          <b-col sm="10" style="text-align: left !important;">  
            <div class="prof-container prof-post" v-for="product in products">
              ...
              <modal
                ...
                name="post" width="500px" height="800px"
                scrollable=true>
              ...
              <div class="user-area">
                <div class="card-op-area">
                  <a :href="products[shownmodalposition].user"><img class="img-user" :src="products[shownmodalposition].user_img"></a>
                  <a :href="products[shownmodalposition].user" class="txt-username"><b>{{products[shownmodalposition].user}}</b></a>
                  <a class="txt-username">•</a>
                  <a class="txt-username txt-tmstmp">{{moment(products[shownmodalposition].timestamp, "YYYY-MM-DDThh:mm:ss").locale('pt-pt').fromNow()}}</a>
              ...
              <div class="card-img-caixa">
                ...
                <img v-if="products[shownmodalposition].imgs.length==1" class="card-img card-img-blur" :src="products[shownmodalposition].imgs[0]">
                <img v-if="products[shownmodalposition].imgs.length==1" class="card-img card-img-front" :src="products[shownmodalposition].imgs[0]" @dblclick="giveliketouch()">
                ...
                <b-carousel v-if="product.imgs.length>1" id="carousel1"
                  ...
                  <b-carousel-slide v-for="image in products[shownmodalposition].imgs" :img-src="image">
                  </b-carousel-slide>
              ...
              <div class="reactions-area">
                <div class="reaction-left-area">
                    ...
                    <b>{{products[shownmodalposition].likes}}</b>
              ...
              <div class="description-area">
                <div class="card-op-area">
                  ...
                  <p v-if="products[shownmodalposition].manufacturer" class="details-post">
                    <b>
                      {{products[shownmodalposition].manufacturer}} ‏‏‎ • ‏‏‎ 
                      {{products[shownmodalposition].size}} ‏‏‎ • ‏‏‎ 
                      {{products[shownmodalposition].color}}
                    </b>
                  </p>
                  <p v-else class="details-post">
                    <b>
                      {{products[shownmodalposition].size}} ‏‏‎ • ‏‏‎ 
                      {{products[shownmodalposition].color}}
                    </b>
                ...
                <div class="card-options-area">
                  <h4 style="color: #4A53FC;"><b>{{products[shownmodalposition].price.toFixed(2)}}€</b></h4>
                </div>
                
                <b-collapse v-bind:id="products[shownmodalposition].id" class="mt-2">
                  <div class="card-op-area">
                    <p class="card-text">{{products[shownmodalposition].description}}</p>
                  </div>
                </b-collapse>
              </div>
              <!-- COMENTÁRIOS -->
              <div class="comment-area">
                ...
                <div class="my-comment">
                  <a :href="products[shownmodalposition].comments[0].user"><img class="img-user" :src="products[shownmodalposition].comments[0].user_img"></a>
                  <div class="comment">
                    <a :href="products[shownmodalposition].comments[0].user" class="txt-username"><b>{{products[shownmodalposition].comments[0].user}}</b></a>
                    <a class="txt-username">{{products[shownmodalposition].comments[0].text}}</a>
                    <a class="txt-username">•</a>
                  <a class="txt-username txt-tmstmp">{{moment(products[shownmodalposition].comments[0].timestamp, "YYYY-MM-DDThh:mm:ss").locale('pt-pt').fromNow()}}</a>
                  </div>
                </div>
                ...
                <div class="my-comment">
                  ...
                  <b-form-textarea class="comment-input" v-model="text" rows="1" max-rows="4" v-bind:id="'comment_'+products[shownmodalposition].id" placeholder="Escreve um comentário..." ></b-form-textarea>
